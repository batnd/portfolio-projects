...
## 1. Лендинг для центра реабилитации в г. Алматы (коммерческий проект).
### Репозиторий проекта: **[лендинг для центра реабилитации в г. Алматы](https://github.com/batnd/landing-rehab-center)**
...
## 2. Веб-приложение - сайт-блог на Angular (учебный проект).
...
## 3. Веб-приложение - интернет-магазин на Angular (учебный проект).
...
## 4. Веб-приложение - учёт финансов (учебный проект).
...
## 5. Веб-приложение - quiz-викторина (учебный проект).
...
## 6. Игра - "Найди пару" - Memory Game (учебный проект).
...
## 7. Игра - "Крестики-нолики" - Tic-Tac-Toe (учебный проект).
...
## 8. Игра - "Змейка" - Snake (учебный проект).
...
## 10. Лендинг для магазина (учебный проект).
...
## 12. Веб-страница (учебный проект).
